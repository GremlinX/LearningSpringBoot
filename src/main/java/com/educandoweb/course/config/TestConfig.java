...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Inside the p1's category "p1.getCategory" i'm going to associate to cat2
		// ".add(cat2)"!
		p1.getCategories().add(cat2);
		// Inside the p2's category "p2.getCategory" i'm going to associate to cat2
		// ".add(cat1)"!
		p2.getCategories().add(cat1);
		// Inside the p2's category "p2.getCategory" i'm going to associate to cat2
		// ".add(cat3)"!
		p2.getCategories().add(cat3);
		// Inside the p3's category "p3.getCategory" i'm going to associate to cat2
		// ".add(cat3)"!
		p3.getCategories().add(cat3);
		// Inside the p4's category "p4.getCategory" i'm going to associate to cat2
		// ".add(cat3)"!
		p4.getCategories().add(cat3);
		// Inside the p5's category "p5.getCategory" i'm going to associate to cat2
		// ".add(cat2)"!
