...
public class Order implements Serializable {
	...
	/** 
	 * mapped by the variable "order" in the line that says "private Order order;" 
	 * which also contains the annotation "@OneToOne".
	 * <br>
	 * "cascade = CascadeType.ALL": We need this when we have to map the relation 
	 * one to one with the same id. If the Order has the id = 3 then Payment also
	 * need the id = 3. 
	 */
